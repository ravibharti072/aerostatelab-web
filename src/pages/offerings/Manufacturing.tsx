...
function Manufacturing() {
  ...
  const heroPoints = [
    ...
    "Raw material and component visibility",
  ...
  const challenges: ChallengeItem[] = [
    {
      title: "Disconnected Production Records",
      description:
        "Orders, material requirements, job progress, quality updates, and finished quantities remain spread across separate sheets.",
    ...
    },
    {
      ...
      description:
        "Production begins without a clear view of required, available, issued, consumed, returned, or shortage quantities.",
      icon: <Boxes className="h-5 w-5" />,
      style: "border-cyan-200 bg-cyan-50 text-cyan-700",
    },
    {
      title: "Limited Shop-Floor Visibility",
      description:
        "Management cannot quickly understand which orders are planned, active, delayed, paused, inspected, or completed.",
    ...
    },
    {
      ...
      description:
        "Production stages, deadlines, priorities, operators, supervisors, and pending actions are not recorded consistently.",
      icon: <Users className="h-5 w-5" />,
      style: "border-emerald-200 bg-emerald-50 text-emerald-700",
    },
    {
      title: "Quality and Defect Gaps",
      description:
        "Inspection results, rejected quantities, rework, defects, and authorised quality decisions become difficult to trace.",
    ...
    },
    {
      ...
      description:
        "Machine issues, downtime, material usage, labour activity, wastage, and production expenses remain disconnected.",
  ...
  const coreFeatures: FeatureItem[] = [
    {
      ...
      description:
        "Create structured product records with components, required quantities, units, versions, and production instructions.",
      points: [
    ...
    {
      title: "Production Orders and Planning",
      description:
        "Create production orders with products, planned quantities, priorities, dates, responsibility, and operational status.",
      points: [
    ...
    },
    {
      ...
      points: [
        ...
        "Consumption and return entries",
      ],
    ...
    },
    {
      ...
      description:
        "Break production into practical work stages and record assignment, quantity, timing, progress, and current status.",
      points: [
        "Production stage structure",
        "Operator and supervisor assignment",
        "Stage quantity updates",
    ...
    {
      title: "Quality, Defects and Rework",
      description:
        "Maintain authorised inspection information and connect accepted, rejected, defective, or rework quantities with production.",
      points: [
    ...
    {
      title: "Finished Goods and Reporting",
      description:
        "Record completed production, finished-goods receipt, wastage, production costs, order performance, and dispatch readiness.",
      points: [
        "Finished quantity records",
        "Warehouse receipt linkage",
        "Wastage and cost information",
  ...
  const workflowSteps: WorkflowStep[] = [
    {
      ...
      description:
        "Record the finished product, components, quantities, units, production notes, applicable version, and required instructions.",
    ...
    },
    {
      ...
      description:
        "Select the product, planned quantity, priority, responsible manager, expected dates, warehouse, and initial status.",
      icon: <Factory className="h-5 w-5" />,
      style: "border-violet-200 bg-violet-50 text-violet-700",
    },
    {
      ...
      description:
        "Compare the production requirement with available component quantities and identify shortages or purchase requirements.",
      icon: <Boxes className="h-5 w-5" />,
      style: "border-cyan-200 bg-cyan-50 text-cyan-700",
    },
    {
      ...
      description:
        "Record items, quantities, warehouse source, production order, issue date, responsible user, and any returned materials.",
    ...
    },
    {
      number: "05",
      stage: "Produce",
      title: "Track Shop-Floor Progress",
      description:
        "Update production stages, assigned users, completed quantities, pending work, delays, machine issues, and operational remarks.",
    ...
    },
    {
      number: "06",
      stage: "Inspect",
      title: "Complete the Quality Check",
      description:
    ...
    },
    {
      number: "07",
      stage: "Complete",
      title: "Receive Finished Goods and Close",
      description:
        "Record finished quantities, wastage, warehouse receipt, production cost information, completion date, and final order status.",
  ...
  const roleViews: RoleViewItem[] = [
    {
      ...
      description:
        "Complete authorised visibility across production orders, materials, shop-floor activity, quality, costs, and reports.",
      permissions: [
        "Manage manufacturing records",
        "Review every production order",
    ...
    },
    {
      ...
      description:
        "Coordinate permitted products, production orders, work stages, priorities, schedules, teams, and completion status.",
      permissions: [
        "Create production orders",
        "Assign stages and users",
    ...
    {
      role: "Store and Procurement",
      description:
        "Access authorised raw material, warehouse, purchase requirement, issue, return, and finished-goods information.",
      permissions: [
    ...
    {
      role: "Supervisor and Quality",
      description:
        "Access assigned work stages, production quantities, inspection records, defects, rework, and operational issues.",
      permissions: [
  ...
  const advantages: AdvantageItem[] = [
    {
      ...
      description:
        "Keep products, BOMs, orders, materials, stages, quality checks, finished goods, and costs connected.",
    ...
    },
    {
      ...
      description:
        "Review permitted production, warehouses, teams, and finished-goods activity across factories, units, or branches.",
    ...
    },
    {
      ...
      description:
        "Limit product, material, production, quality, cost, and reporting information according to each user's responsibility.",
    ...
    },
    {
      ...
      description:
        "Use connected records to review production progress, output, material usage, rejection, wastage, delays, and costs.",
    ...
    <div className="overflow-hidden bg-white text-slate-900">
        ...
        <div className="mx-auto grid w-full max-w-[1440px] grid-cols-1 items-center gap-12 px-4 py-14 sm:px-6 sm:py-20 lg:grid-cols-[1.06fr_0.94fr] lg:gap-20 lg:px-10 lg:py-24 xl:px-16">
          ...
          <div className="mx-auto max-w-3xl text-center lg:mx-0 lg:text-left">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:justify-center lg:justify-start">
              ...
              >
                Explore Manufacturing Features
        ...
        <div className="mx-auto w-full max-w-[1440px] px-4 py-16 sm:px-6 sm:py-20 lg:px-10 lg:py-24 xl:px-16">
          <div className="mx-auto max-w-3xl text-center">
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-rose-600">
              Manufacturing Workflow Challenges
            </span>
            ...
            <p className="mt-5 text-base leading-8 text-slate-600">
              Manufacturing becomes difficult to control when products,
              production orders, materials, shop-floor updates, quality
              checks, finished goods, and costs remain separated across
      ...
      >
        ...
        <div className="mx-auto w-full max-w-[1440px] px-4 py-16 sm:px-6 sm:py-20 lg:px-10 lg:py-24 xl:px-16">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-slate-950 sm:text-4xl">
              Manage Every Operational Layer of Production
            </h2>

            <p className="mt-5 text-base leading-8 text-slate-600">
              Connect products, BOMs, production orders, materials,
              shop-floor stages, quality checks, finished goods, costs,
              and reporting through one structured manufacturing system.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[0.72fr_1.28fr] lg:items-start lg:gap-20">
            <div className="lg:sticky lg:top-28">
              ...
              <p className="mt-5 text-base leading-8 text-slate-600">
                ...
                material, shop-floor, quality, warehouse, and cost files.
              </p>
        ...
        <div className="mx-auto w-full max-w-[1440px] px-4 py-16 sm:px-6 sm:py-20 lg:px-10 lg:py-24 xl:px-16">
          <div className="mx-auto max-w-3xl text-center">
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-emerald-600">
              Permission-Based Manufacturing Access
            </span>
            ...
            <p className="mt-5 text-base leading-8 text-slate-600">
              Management, production teams, warehouse users,
              procurement staff, supervisors, and quality teams require
      ...
      <section className="border-y border-slate-200 bg-white">
        <div className="mx-auto grid w-full max-w-[1440px] grid-cols-1 gap-12 px-4 py-16 sm:px-6 sm:py-20 lg:grid-cols-[0.8fr_1.2fr] lg:items-center lg:gap-20 lg:px-10 xl:px-16">
          <div>
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-blue-600">
              Manufacturing Platform Advantages
            </span>
            ...
            <p className="mt-5 text-base leading-8 text-slate-600">
              ...
              production books, quality files, warehouse entries, and
              cost reports with one connected cloud-based
        ...
        <div className="mx-auto grid w-full max-w-[1440px] grid-cols-1 gap-12 px-4 py-16 sm:px-6 sm:py-20 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-20 lg:px-10 lg:py-24 xl:px-16">
          <div>
            <span className="inline-flex items-center gap-2 rounded-full border border-blue-400/20 bg-blue-400/10 px-4 py-2 text-[10px] font-bold uppercase tracking-[0.16em] text-blue-300">
              ...
              Cloud Manufacturing Management
            </span>
            ...
            <p className="mt-5 text-base leading-8 text-slate-300">
              ...
              production orders, materials, stage updates, quality
              records, finished goods, costs, and reports through
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            {[
              {
                title: "Responsive Production Access",
                description:
                  "Access permitted order, material, shop-floor, quality, warehouse, and reporting records through phone, tablet, laptop, or desktop.",
              ...
              },
              {
                ...
                description:
                  "Keep BOMs, orders, issues, stage updates, inspections, defects, finished quantities, and notes within structured records.",
                icon: <FileCheck2 className="h-6 w-6" />,
              },
              {
                title: "Expandable Manufacturing Modules",
                description:
