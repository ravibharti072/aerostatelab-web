...
function Education() {
  // Reduced tags
  const tags = ["Student Management", "LMS", "Examinations", "Fee Management"];

  // Core features – each with icon, short desc, and only 4 points
  const coreFeatures = [
    { icon: <Users className="w-5 h-5" />, title: "Student Information", desc: "Complete student lifecycle management.", points: ["Student profiles & history", "Enrollment management", "Course allocation", "Multi-campus tracking"] },
    { icon: <GraduationCap className="w-5 h-5" />, title: "Admission Management", desc: "Automated digital enrollment.", points: ["Online applications", "Eligibility verification", "Merit list generation", "Seat allocation"] },
    { icon: <BookOpen className="w-5 h-5" />, title: "Academic & Curriculum", desc: "Organize courses and planning.", points: ["Curriculum planning", "Course structure", "Academic calendar", "Faculty assignment"] },
    { icon: <Monitor className="w-5 h-5" />, title: "Learning Management (LMS)", desc: "Digital classroom & content.", points: ["Online course delivery", "Assignment management", "Study materials", "Learning analytics"] },
    { icon: <CalendarCheck className="w-5 h-5" />, title: "Attendance & Timetable", desc: "Automated scheduling & tracking.", points: ["Student/faculty attendance", "Automated timetable", "Leave management", "Real-time monitoring"] },
    { icon: <FileText className="w-5 h-5" />, title: "Examination System", desc: "Manage exams & grading.", points: ["Exam scheduling", "Online/offline exams", "Automated grading", "Report cards"] },
    { icon: <CreditCard className="w-5 h-5" />, title: "Fee Management", desc: "Simplify fee collection.", points: ["Fee structure", "Online payments", "Discounts & scholarships", "Payment reminders"] },
    { icon: <Briefcase className="w-5 h-5" />, title: "Faculty & Staff", desc: "Manage workforce efficiently.", points: ["Faculty profiles", "Workload management", "Payroll integration", "Performance evaluation"] }
  ];

  // Advanced capabilities – condensed to 4 main areas
  const capabilities = [
    { title: "Education Automation", points: ["Automated admissions", "Attendance automation", "Fee reminders", "Exam scheduling automation"] },
    { title: "Analytics & Reporting", points: ["Student performance dashboards", "Attendance analytics", "Fee collection reports", "Enrollment analytics"] },
    { title: "Real-Time Visibility", points: ["Live student dashboards", "Attendance monitoring", "Fee status tracking", "Faculty activity tracking"] },
    { title: "Mobile & Security", points: ["Mobile attendance & fees", "Student/parent access", "Role-based security", "Data encryption"] }
  ];

  // Benefits – measurable impacts (like Analytics page)
  const benefits = [
    { metric: "40%", desc: "Reduced administrative workload" },
    { metric: "30%", desc: "Improved student outcomes" },
    { metric: "50%", desc: "Faster admission processing" },
    { metric: "24/7", desc: "Campus-wide accessibility" }
  ];

  // Why choose – 4 simple reasons
  const whyChoose = [
    "Scalable for K-12 to universities",
    "End-to-end academic control",
    "Real-time education intelligence",
    "Cloud & mobile accessibility"
  ];

  // Institutions served – condensed list
  const industries = [
    "Schools", "Colleges", "Universities", "Coaching Centers",
    "Online Learning Platforms", "EdTech Companies", "Research Institutions"
  ];
    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 to-white pt-28 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in-up">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto mb-8 leading-relaxed">
            Transform schools, colleges, and universities with an intelligent platform for student management, admissions, learning, examinations, and administration.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-12 animate-fade-in-up">
          <h2 className="text-3xl font-extrabold text-gray-900">Core Education Modules</h2>
          <p className="text-gray-500 mt-2">Complete toolkit for academic institutions.</p>
        </div>
      ...
      <section className="bg-blue-50/50 border-y border-blue-100 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12 animate-fade-in-up">
            <h2 className="text-3xl font-extrabold text-gray-900">Advanced Education Architecture</h2>
      ...
      {/* BENEFITS + WHY CHOOSE + INSTITUTIONS – two-column layout */}
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-10">
            ...
            <div className="animate-fade-in-up">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Institutions We Serve</h3>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24 text-center">
        <div className="bg-blue-600 rounded-3xl p-10 shadow-xl shadow-blue-200 animate-fade-in-up">
          <h2 className="text-3xl font-extrabold text-white mb-4">Transform Your Education System</h2>
          <p className="text-blue-100 mb-8 max-w-xl mx-auto">
            Modernize academic operations with a powerful ERP platform for efficiency, transparency, and digital learning.
          </p>
          <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-3.5 bg-white text-blue-600 rounded-xl text-sm font-bold hover:bg-blue-50 transition-colors shadow-md animate-pulse-soft">
            Deploy Education Architecture <span>→</span>
          </Link>
        </div>
      </section>
    </div>
