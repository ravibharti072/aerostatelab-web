...
function Retail() {
  // Reduced tags
  const tags = ["Point of Sale", "Inventory Sync", "Multi-Store", "Customer Loyalty"];

  // Core features – each with icon, short desc, and only 4 points
  const coreFeatures = [
    { icon: <ShoppingCart className="w-5 h-5" />, title: "Point of Sale (POS)", desc: "Fast, accurate checkout processing.", points: ["Barcode scanning", "Digital & cash payments", "Discount & coupons", "Multi-terminal support"] },
    { icon: <Package className="w-5 h-5" />, title: "Retail Inventory", desc: "Real-time stock visibility.", points: ["Stock tracking", "SKU management", "Low stock alerts", "Batch & serial tracking"] },
    { icon: <Store className="w-5 h-5" />, title: "Multi-Store Management", desc: "Centralized store control.", points: ["Store performance", "Inter-store transfers", "Regional analytics", "Unified pricing"] },
    { icon: <CreditCard className="w-5 h-5" />, title: "Billing & Payments", desc: "Simplify payment processing.", points: ["GST/VAT billing", "Multiple gateways", "Refund & exchange", "Settlement reports"] },
    { icon: <Heart className="w-5 h-5" />, title: "Customer Loyalty", desc: "Build lasting relationships.", points: ["Profile management", "Loyalty points", "Personalized offers", "Retention tracking"] },
    { icon: <Percent className="w-5 h-5" />, title: "Sales & Promotions", desc: "Boost retail revenue.", points: ["Promotional pricing", "Discount rules", "Combo offers", "Campaign analytics"] },
    { icon: <Truck className="w-5 h-5" />, title: "Procurement & Suppliers", desc: "Coordinate replenishment.", points: ["Supplier database", "Purchase orders", "Stock replenishment", "Performance tracking"] },
    { icon: <BarChart3 className="w-5 h-5" />, title: "Retail Analytics", desc: "Data-driven insights.", points: ["Sales dashboards", "Product performance", "Customer behavior", "Profit margin analysis"] }
  ];

  // Advanced capabilities – condensed to 4 main areas
  const capabilities = [
    { title: "Retail Automation", points: ["Automated billing", "Inventory sync", "Smart replenishment", "Low stock alerts"] },
    { title: "Omnichannel Management", points: ["E-commerce integration", "Unified inventory", "Click & collect", "Cross-platform sync"] },
    { title: "Mobile Retail", points: ["Mobile POS", "Sales monitoring", "Inventory lookup", "Store dashboards"] },
    { title: "Security & Control", points: ["Role-based access", "Secure payments", "Audit logs", "Fraud prevention"] }
  ];

  // Benefits – measurable impacts
  const benefits = [
    { metric: "40%", desc: "Faster checkout time" },
    { metric: "30%", desc: "Reduced stock discrepancies" },
    { metric: "25%", desc: "Higher customer retention" },
    { metric: "100%", desc: "Real-time sales visibility" }
  ];

  // Why choose – 4 simple reasons
  const whyChoose = [
    "Scalable from single store to franchises",
    "Real-time retail visibility",
  ...
  const industries = [
    "Supermarkets & Grocery", "Fashion & Apparel", "Electronics Stores",
    "Pharmacy Retail", "Furniture", "Restaurants", "Wholesale", "Franchise Chains"
  ];
    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 to-white pt-28 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in-up">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto mb-8 leading-relaxed">
            Streamline operations, optimize sales, enhance customer experiences, and simplify point-of-sale transactions with an intelligent retail platform.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-12 animate-fade-in-up">
          <h2 className="text-3xl font-extrabold text-gray-900">Core Retail Modules</h2>
          <p className="text-gray-500 mt-2">Complete control over store operations.</p>
        </div>
      ...
      <section className="bg-blue-50/50 border-y border-blue-100 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12 animate-fade-in-up">
            <h2 className="text-3xl font-extrabold text-gray-900">Advanced Retail Architecture</h2>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24 text-center">
        <div className="bg-blue-600 rounded-3xl p-10 shadow-xl shadow-blue-200 animate-fade-in-up">
          <h2 className="text-3xl font-extrabold text-white mb-4">Transform Your Retail Operations</h2>
          <p className="text-blue-100 mb-8 max-w-xl mx-auto">
            Modernize store management and customer service for efficiency, scalability, and seamless experiences.
          </p>
          <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-3.5 bg-white text-blue-600 rounded-xl text-sm font-bold hover:bg-blue-50 transition-colors shadow-md animate-pulse-soft">
            Deploy Retail Architecture <span>→</span>
          </Link>
        </div>
      </section>
    </div>
