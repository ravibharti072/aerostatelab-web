...
function Hospitality() {
  // Reduced tags
  const tags = ["Reservations", "Guest Management", "Housekeeping", "Billing"];

  // Core features – each with icon, short desc, and only 4 points
  const coreFeatures = [
    { icon: <Calendar className="w-5 h-5" />, title: "Reservation & Booking", desc: "Manage guest bookings in real time.", points: ["Online & offline booking", "Real-time availability", "Group booking management", "Channel integration"] },
    { icon: <Users className="w-5 h-5" />, title: "Front Office & Guest", desc: "Seamless check-in/out experiences.", points: ["Digital check-in/out", "Guest profile & history", "Room assignment", "Loyalty tracking"] },
    { icon: <Hotel className="w-5 h-5" />, title: "Room & Property", desc: "Manage rooms, categories, pricing.", points: ["Room inventory", "Dynamic pricing", "Occupancy tracking", "Multi-property support"] },
    { icon: <Sparkles className="w-5 h-5" />, title: "Housekeeping", desc: "Optimize cleaning operations.", points: ["Room cleaning schedules", "Task assignment", "Room status tracking", "Inspection workflows"] },
    { icon: <Utensils className="w-5 h-5" />, title: "Restaurant & Food Service", desc: "Manage dining and room service.", points: ["Room service ordering", "POS integration", "Order tracking", "Inventory tracking"] },
    { icon: <Receipt className="w-5 h-5" />, title: "Billing & Revenue", desc: "Streamline payments and finances.", points: ["Automated invoices", "Multi-payment support", "Tax calculation", "Revenue dashboards"] },
    { icon: <Briefcase className="w-5 h-5" />, title: "Staff & Shift", desc: "Manage hospitality workforce.", points: ["Staff scheduling", "Shift allocation", "Attendance tracking", "Payroll integration"] },
    { icon: <Heart className="w-5 h-5" />, title: "Guest Experience & CRM", desc: "Enhance satisfaction & loyalty.", points: ["Guest profiles", "Feedback & reviews", "Loyalty programs", "Personalized offers"] }
  ];

  // Advanced capabilities – condensed to 4 main areas
  const capabilities = [
    { title: "Hospitality Automation", points: ["Booking confirmations", "Dynamic room pricing", "Housekeeping tasks", "Billing automation"] },
    { title: "Analytics & Reporting", points: ["Occupancy dashboards", "Revenue performance", "Booking trends", "Guest satisfaction"] },
    { title: "Real-Time Visibility", points: ["Room status tracking", "Check-in/out monitoring", "Housekeeping progress", "Multi-property overview"] },
    { title: "Security & Compliance", points: ["Role-based access", "Guest data encryption", "Audit logs", "Secure payments"] }
  ];

  // Benefits – measurable impacts
  const benefits = [
    { metric: "30%", desc: "Higher occupancy rates" },
    { metric: "25%", desc: "Increased revenue per room" },
    { metric: "40%", desc: "Faster check-in/out" },
    { metric: "50%", desc: "Better staff efficiency" }
  ];

  // Why choose – 4 simple reasons
  const whyChoose = [
    "Scalable for single hotels to chains",
    "End-to-end hospitality management",
    "Real-time operational intelligence",
    "Cloud & mobile accessibility"
  ];

  // Properties served – condensed list
  const industries = [
    "Hotels & Resorts", "Boutique Hotels", "Luxury Resorts", "Budget Hotels",
    "Service Apartments", "Guest Houses", "Hospitality Chains"
  ];
    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 to-white pt-28 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in-up">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto mb-8 leading-relaxed">
            Streamline hotel operations, guest management, reservations, housekeeping, billing, and service delivery with an intelligent platform.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-12 animate-fade-in-up">
          <h2 className="text-3xl font-extrabold text-gray-900">Core Hospitality Modules</h2>
          <p className="text-gray-500 mt-2">Complete hotel management toolkit.</p>
        </div>
      ...
      <section className="bg-blue-50/50 border-y border-blue-100 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12 animate-fade-in-up">
            <h2 className="text-3xl font-extrabold text-gray-900">Advanced Hospitality Architecture</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-10">
            ...
            <div className="animate-fade-in-up">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Properties We Serve</h3>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24 text-center">
        <div className="bg-blue-600 rounded-3xl p-10 shadow-xl shadow-blue-200 animate-fade-in-up">
          <h2 className="text-3xl font-extrabold text-white mb-4">Transform Your Hospitality Operations</h2>
          <p className="text-blue-100 mb-8 max-w-xl mx-auto">
            Modernize hotel management for efficiency, guest satisfaction, and revenue optimization.
          </p>
          <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-3.5 bg-white text-blue-600 rounded-xl text-sm font-bold hover:bg-blue-50 transition-colors shadow-md animate-pulse-soft">
            Deploy Hospitality Architecture <span>→</span>
          </Link>
        </div>
      </section>
    </div>
