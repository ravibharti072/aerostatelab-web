...
function Finance() {
  // Reduced tags
  const tags = ["Accounting", "Budgeting", "Cash Flow", "Compliance"];

  // Core features – each with icon, short desc, and only 4 points
  const coreFeatures = [
    { icon: <BookOpen className="w-5 h-5" />, title: "General Ledger", desc: "Centralized financial accounting.", points: ["Chart of accounts", "Journal entry automation", "Multi-currency support", "Real-time ledger updates"] },
    { icon: <Receipt className="w-5 h-5" />, title: "Accounts Payable", desc: "Automate vendor payments.", points: ["Vendor invoice management", "Payment scheduling", "Approval workflows", "Due date notifications"] },
    { icon: <CreditCard className="w-5 h-5" />, title: "Accounts Receivable", desc: "Track incoming payments.", points: ["Customer invoice generation", "Aging analysis", "Automated reminders", "Receipt management"] },
    { icon: <Target className="w-5 h-5" />, title: "Budgeting & Planning", desc: "Plan and control finances.", points: ["Budget creation", "Revenue projections", "Variance analysis", "Cost allocation"] },
    { icon: <Wallet className="w-5 h-5" />, title: "Cash Flow Management", desc: "Monitor liquidity in real time.", points: ["Cash flow forecasting", "Bank account monitoring", "Liquidity analysis", "Real-time visibility"] },
    { icon: <FileText className="w-5 h-5" />, title: "Tax & Compliance", desc: "Ensure regulatory compliance.", points: ["GST/VAT management", "Tax calculation automation", "Audit-ready reports", "Compliance alerts"] },
    { icon: <DollarSign className="w-5 h-5" />, title: "Expense Management", desc: "Control operational expenses.", points: ["Expense claims", "Approval workflows", "Policy enforcement", "Expense analytics"] },
    { icon: <BarChart3 className="w-5 h-5" />, title: "Financial Reporting", desc: "Real-time insights.", points: ["P&L statements", "Balance sheet", "Cash flow reports", "Financial dashboards"] }
  ];

  // Advanced capabilities – condensed to 4 main areas
  const capabilities = [
    { title: "Finance Automation", points: ["Automated journal entries", "Invoice processing", "Bank reconciliation automation", "Recurring billing"] },
    { title: "Multi-Entity Management", points: ["Branch-wise accounting", "Consolidated reporting", "Inter-company transactions", "Centralized visibility"] },
    { title: "Banking Integration", points: ["Bank reconciliation", "Online payments", "Automated transaction import", "Payment gateway integration"] },
    { title: "Security & Access", points: ["Role-based access", "Audit trails", "Data encryption", "Multi-level approvals"] }
  ];

  // Benefits – measurable impacts
  const benefits = [
    { metric: "50%", desc: "Faster financial close" },
    { metric: "40%", desc: "Reduced accounting errors" },
    { metric: "30%", desc: "Improved cash flow visibility" },
    { metric: "100%", desc: "Regulatory compliance" }
  ];

  // Why choose – 4 simple reasons
  const whyChoose = [
    "Scalable for SMEs to enterprises",
    "Real-time financial visibility",
    "Intelligent accounting automation",
    "Cloud & multi-entity support"
  ];

  // Industries served – condensed list
  const industries = [
    "Manufacturing", "Retail & E-commerce", "Healthcare", "Logistics",
    "Real Estate", "Construction", "IT Services", "Corporate Enterprises"
  ];
    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 to-white pt-28 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in-up">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto mb-8 leading-relaxed">
            Simplify financial operations, automate accounting workflows, and gain real-time control over business finances.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-12 animate-fade-in-up">
          <h2 className="text-3xl font-extrabold text-gray-900">Core Finance Modules</h2>
          <p className="text-gray-500 mt-2">Complete toolkit for modern accounting.</p>
        </div>
      ...
      <section className="bg-blue-50/50 border-y border-blue-100 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12 animate-fade-in-up">
            <h2 className="text-3xl font-extrabold text-gray-900">Advanced Finance Architecture</h2>
            <p className="text-gray-500 mt-2">Automation, multi-entity, integration, and security.</p>
          </div>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24 text-center">
        <div className="bg-blue-600 rounded-3xl p-10 shadow-xl shadow-blue-200 animate-fade-in-up">
          <h2 className="text-3xl font-extrabold text-white mb-4">Modernize Your Financial Operations</h2>
          <p className="text-blue-100 mb-8 max-w-xl mx-auto">
            Transform accounting and financial management with automation, accuracy, and real-time insights.
          </p>
          <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-3.5 bg-white text-blue-600 rounded-xl text-sm font-bold hover:bg-blue-50 transition-colors shadow-md animate-pulse-soft">
            Deploy Finance Architecture <span>→</span>
          </Link>
        </div>
      </section>
    </div>
