...
function Manufacturing() {
  ...
  const coreFeatures = [
    { icon: <Calendar className="w-5 h-5" />, title: "Production Planning & Scheduling", desc: "Optimize manufacturing schedules.", points: ["Production orders", "Capacity planning", "Work order management", "Deadline monitoring"] },
    ...
    { icon: <ShieldCheck className="w-5 h-5" />, title: "Quality Control Management", desc: "Maintain product standards.", points: ["Inspection workflows", "Defect tracking", "Compliance monitoring", "Audit trails"] },
    { icon: <Gauge className="w-5 h-5" />, title: "Machine & Equipment Monitoring", desc: "Track equipment performance.", points: ["Performance monitoring", "Maintenance scheduling", "Breakdown management", "Asset lifecycle"] },
    { icon: <DollarSign className="w-5 h-5" />, title: "Production Cost Management", desc: "Analyze manufacturing expenses.", points: ["Cost calculation", "Material & labor cost", "Overhead allocation", "Profitability analysis"] },
  ...
  const capabilities = [
    ...
    { title: "Analytics & Reporting", points: ["Efficiency reports", "Downtime analysis", "Quality performance", "Cost analysis"] },
    { title: "Real-Time Factory Visibility", points: ["Production dashboards", "Material visibility", "Bottleneck detection", "Plant-wide monitoring"] },
      ...
      <section className="relative bg-gradient-to-br from-blue-50 to-white pt-28 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in-up">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto mb-8 leading-relaxed">
            Optimize production planning, factory operations, material tracking, and quality control with an intelligent platform.
          </p>
