...
function Trading() {
  // Reduced tags
  const tags = ["Trade Management", "Inventory Control", "Multi-Channel", "Procurement"];

  // Core features – each with icon, short desc, and only 4 points
  const coreFeatures = [
    { icon: <ShoppingBag className="w-5 h-5" />, title: "Trade & Order Management", desc: "Manage complex sales and purchase orders.", points: ["Sales & purchase orders", "Multi-currency support", "Backorder management", "Automated invoicing"] },
    { icon: <Package className="w-5 h-5" />, title: "Inventory & Stock Control", desc: "Real-time visibility across locations.", points: ["Multi-warehouse tracking", "SKU & barcode support", "Batch & expiry tracking", "Low stock alerts"] },
    { icon: <Truck className="w-5 h-5" />, title: "Procurement & Sourcing", desc: "Streamline purchasing operations.", points: ["Purchase requisitions", "Supplier management", "Vendor price comparison", "Automated reordering"] },
    { icon: <BarChart3 className="w-5 h-5" />, title: "Supply Chain & Logistics", desc: "Coordinate distribution efficiently.", points: ["Distribution planning", "Freight cost calculation", "Delivery tracking", "Warehouse transfers"] },
    { icon: <Globe className="w-5 h-5" />, title: "Multi-Channel Sales", desc: "Synchronize across all channels.", points: ["E-commerce integration", "B2B portal support", "Cross-platform stock sync", "Omnichannel reporting"] },
    { icon: <DollarSign className="w-5 h-5" />, title: "Financial Management", desc: "Handle trade-specific accounting.", points: ["Automated billing", "AR/AP management", "Tax & GST compliance", "Profit margin analysis"] },
    { icon: <Users className="w-5 h-5" />, title: "Customer & Vendor Mgmt", desc: "Build strong trade relationships.", points: ["CRM integration", "Credit management", "Contract management", "Performance analytics"] },
    { icon: <TrendingUp className="w-5 h-5" />, title: "Analytics & Forecasting", desc: "Data-driven trade decisions.", points: ["Sales forecasting", "Inventory turnover", "Demand planning", "Real-time KPI dashboards"] }
  ];

  // Advanced capabilities – condensed to 4 main areas
  const capabilities = [
    { title: "Trade Automation", points: ["Automated order routing", "Smart procurement", "Invoice automation", "Inventory sync"] },
    { title: "Business Intelligence", points: ["Sales dashboards", "Margin monitoring", "Vendor analytics", "Demand planning"] },
    { title: "Real-Time Visibility", points: ["Live stock levels", "Order tracking", "Shipment status", "Financial summaries"] },
    { title: "Mobile & Security", points: ["Mobile order management", "Role-based access", "Audit logs", "Data encryption"] }
  ];

  // Benefits – measurable impacts
  const benefits = [
    { metric: "25%", desc: "Higher profit margins" },
    { metric: "30%", desc: "Faster fulfillment cycles" },
    { metric: "20%", desc: "Reduced inventory costs" },
    { metric: "100%", desc: "Real-time trade visibility" }
  ];

  // Why choose – 4 simple reasons
  const whyChoose = [
    "Scalable for SMEs to large distributors",
  ...
  const industries = [
    "Wholesale Distribution", "Importers & Exporters", "Retail Chains",
    "E-commerce Trade", "FMCG Trading", "Electronics Distribution", "Pharma Trading"
  ];
    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 to-white pt-28 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in-up">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto mb-8 leading-relaxed">
            Optimize procurement, multi-channel sales, inventory control, and supply chain with a centralized trading platform.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-12 animate-fade-in-up">
          <h2 className="text-3xl font-extrabold text-gray-900">Core Trading Modules</h2>
          <p className="text-gray-500 mt-2">Complete control over commerce operations.</p>
        </div>
      ...
      <section className="bg-blue-50/50 border-y border-blue-100 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12 animate-fade-in-up">
            <h2 className="text-3xl font-extrabold text-gray-900">Advanced Trading Architecture</h2>
            <p className="text-gray-500 mt-2">Automation, intelligence, visibility, and security.</p>
          </div>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24 text-center">
        <div className="bg-blue-600 rounded-3xl p-10 shadow-xl shadow-blue-200 animate-fade-in-up">
          <h2 className="text-3xl font-extrabold text-white mb-4">Transform Your Trade Operations</h2>
          <p className="text-blue-100 mb-8 max-w-xl mx-auto">
            Modernize procurement, sales, and supply chain management with an intelligent platform for growth.
          </p>
          <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-3.5 bg-white text-blue-600 rounded-xl text-sm font-bold hover:bg-blue-50 transition-colors shadow-md animate-pulse-soft">
            Deploy Trade Architecture <span>→</span>
          </Link>
        </div>
      </section>
    </div>
