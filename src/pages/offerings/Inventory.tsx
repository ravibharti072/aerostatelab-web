...
function Inventory() {
  // Reduced tags
  const tags = ["Inventory Control", "Warehouse Ops", "Stock Tracking", "Order Fulfillment"];

  // Core features – each with icon, short desc, and only 4 points
  const coreFeatures = [
    { icon: <Package className="w-5 h-5" />, title: "Inventory Management", desc: "Centralized multi-location stock control.", points: ["Real-time stock tracking", "SKU & batch tracking", "Stock transfers", "Low stock alerts"] },
    { icon: <Warehouse className="w-5 h-5" />, title: "Warehouse Operations", desc: "Optimized receiving, picking, and shipping.", points: ["Goods receiving", "Putaway optimization", "Picking & packing", "Dispatch management"] },
    { icon: <QrCode className="w-5 h-5" />, title: "Barcode & QR Integration", desc: "Improve accuracy with scanning.", points: ["Barcode label generation", "Mobile scanning", "Fast stock verification", "Batch scanning"] },
    { icon: <ShoppingCart className="w-5 h-5" />, title: "Procurement & Replenishment", desc: "Automated stock replenishment.", points: ["Auto purchase requisitions", "Reorder level mgmt", "Demand forecasting", "Supplier coordination"] },
    { icon: <Truck className="w-5 h-5" />, title: "Order Fulfillment", desc: "Streamlined order processing.", points: ["Pick list generation", "Packing verification", "Shipment tracking", "Returns management"] },
    { icon: <ClipboardCheck className="w-5 h-5" />, title: "Stock Auditing", desc: "Maintain inventory accuracy.", points: ["Cycle counting", "Physical verification", "Variance reporting", "Audit trails"] },
    { icon: <Building2 className="w-5 h-5" />, title: "Multi-Warehouse", desc: "Unified control across locations.", points: ["Centralized monitoring", "Inter-warehouse transfers", "Regional allocation", "Consolidated analytics"] }
  ];

  // Advanced capabilities – condensed to 4 main areas
  const capabilities = [
    { title: "Warehouse Automation", points: ["Automated stock updates", "Smart replenishment", "Picking route optimization", "Real-time sync"] },
    { title: "Analytics & Reporting", points: ["Inventory turnover", "Stock aging analysis", "Warehouse utilization", "Fulfillment dashboards"] },
    { title: "Supply Chain Visibility", points: ["Live inventory monitoring", "Supplier performance", "Shipment tracking", "Demand forecasting"] },
    { title: "Security & Mobile", points: ["Role-based access", "Mobile scanning", "Audit logs", "Approval workflows"] }
  ];

  // Benefits – measurable impacts
  const benefits = [
    { metric: "30%", desc: "Reduction in stock discrepancies" },
    { metric: "40%", desc: "Faster order fulfillment" },
    { metric: "25%", desc: "Lower carrying costs" },
    { metric: "100%", desc: "Real-time inventory visibility" }
  ];

  // Why choose – 4 simple reasons
  const whyChoose = [
    "Scalable for single to multi-warehouse",
  ...
  const industries = [
    ...
    "Wholesale", "Pharmaceutical", "FMCG", "Healthcare"
  ];
    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 to-white pt-28 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in-up">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto mb-8 leading-relaxed">
            Streamline inventory control, warehouse operations, and order fulfillment with an intelligent system designed for speed and accuracy.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-12 animate-fade-in-up">
          <h2 className="text-3xl font-extrabold text-gray-900">Core Inventory & Warehouse Modules</h2>
          <p className="text-gray-500 mt-2">Complete control over stock and operations.</p>
        </div>
      ...
      <section className="bg-blue-50/50 border-y border-blue-100 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12 animate-fade-in-up">
            <h2 className="text-3xl font-extrabold text-gray-900">Advanced Warehouse Architecture</h2>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24 text-center">
        <div className="bg-blue-600 rounded-3xl p-10 shadow-xl shadow-blue-200 animate-fade-in-up">
          <h2 className="text-3xl font-extrabold text-white mb-4">Optimize Inventory & Warehouse Operations</h2>
          <p className="text-blue-100 mb-8 max-w-xl mx-auto">
            Transform your inventory control and warehouse management for efficiency, visibility, and scalability.
          </p>
          <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-3.5 bg-white text-blue-600 rounded-xl text-sm font-bold hover:bg-blue-50 transition-colors shadow-md animate-pulse-soft">
            Deploy Warehouse Architecture <span>→</span>
          </Link>
        </div>
      </section>
    </div>
