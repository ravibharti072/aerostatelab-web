...
function Inventory() {
  useEffect(() => {
    document.title =
      "Inventory and Warehouse Management Software | AeroState Lab";
  ...
  const heroPoints = [
    "Item, SKU and unit management",
    "Stock receipt and issue tracking",
  ...
  const challenges: ChallengeItem[] = [
    {
      title: "Disconnected Stock Records",
      description:
        "Stock quantities, purchase information, issue records, and location details remain spread across registers and spreadsheets.",
      icon: <Workflow className="h-5 w-5" />,
      style: "border-blue-200 bg-blue-50 text-blue-700",
    },
    {
      title: "Unclear Available Quantity",
      description:
        "Teams cannot quickly confirm what is available, reserved, issued, damaged, transferred, or waiting to be received.",
      icon: <Boxes className="h-5 w-5" />,
      style: "border-cyan-200 bg-cyan-50 text-cyan-700",
    },
    {
      title: "Receiving Information Gaps",
      description:
        "Supplier, order, quantity, receipt date, warehouse, and verification details are not recorded consistently.",
      icon: <PackagePlus className="h-5 w-5" />,
      style: "border-violet-200 bg-violet-50 text-violet-700",
    },
    {
      title: "Uncontrolled Stock Issues",
      description:
        "Items are issued to departments, projects, sites, or staff without clear quantity, purpose, or responsible-user records.",
      icon: <PackageMinus className="h-5 w-5" />,
      style: "border-emerald-200 bg-emerald-50 text-emerald-700",
    },
    {
      title: "Transfer Mismatches",
      description:
        "Stock moved between branches, stores, warehouses, or sites becomes difficult to reconcile at both locations.",
      icon: <Truck className="h-5 w-5" />,
      style: "border-amber-200 bg-amber-50 text-amber-700",
    },
    {
      title: "Delayed Inventory Reporting",
      description:
        "Management waits for manually prepared summaries before understanding shortages, movement, adjustments, and current stock.",
  ...
  const coreFeatures: FeatureItem[] = [
    {
      title: "Item and SKU Master",
      description:
        "Create structured item records with identifiers, categories, units, descriptions, status, and inventory information.",
      points: [
        "Item name and SKU",
        "Category and unit records",
        "Item status and description",
    ...
    {
      title: "Stock Receipt and Inward",
      description:
        "Record incoming stock against suppliers, purchase activity, warehouse locations, dates, quantities, and references.",
      points: [
        "Supplier and receipt details",
        "Received quantity records",
        "Warehouse or store selection",
    ...
    {
      title: "Stock Issue and Consumption",
      description:
        "Maintain clear records when items are issued to departments, projects, sites, employees, customers, or operations.",
      points: [
        "Issued quantity and date",
        "Department or project linkage",
        "Purpose and recipient details",
        "Responsible-user records",
      ],
    ...
    {
      title: "Warehouse and Location Control",
      description:
        "Organise stock according to warehouse, branch, store, site, room, rack, or another business location structure.",
      points: [
    ...
    {
      title: "Purchasing and Supplier Linkage",
      description:
        "Connect stock requirements with supplier details, purchase requests, ordering activity, and received quantities.",
      points: [
    ...
    {
      title: "Adjustments, Audits and Reports",
      description:
        "Record authorised quantity corrections and review stock balances, movement history, shortages, and operational activity.",
      points: [
        "Stock adjustment records",
        "Physical verification entries",
        "Movement and balance reports",
        "Date, item and status filters",
      ],
  ...
  const workflowSteps: WorkflowStep[] = [
    {
      number: "01",
      stage: "Create",
      title: "Create the Inventory Item",
      description:
        "Record the item name, SKU, category, unit, description, active status, and any business-specific item information.",
    ...
    },
    {
      number: "02",
      stage: "Locate",
      title: "Assign the Storage Location",
      description:
        "Connect the item with the relevant warehouse, branch, store, site, rack, or other inventory location.",
    ...
    },
    {
      number: "03",
      stage: "Request",
      title: "Record the Stock Requirement",
      description:
        "Create a requirement or purchase request with item, quantity, required date, department, project, or location details.",
    ...
    },
    {
      number: "04",
      stage: "Receive",
      title: "Receive and Verify Stock",
      description:
        "Record the supplier, received quantity, warehouse, receipt date, order reference, and authorised verification information.",
    ...
    },
    {
      number: "05",
      stage: "Issue",
      title: "Issue or Transfer the Item",
      description:
        "Issue stock to an authorised user, department, project, site, or customer, or transfer it between inventory locations.",
      icon: <Truck className="h-5 w-5" />,
      style: "border-amber-200 bg-amber-50 text-amber-700",
    },
    {
      number: "06",
      stage: "Verify",
      title: "Reconcile Physical Stock",
      description:
        "Compare recorded quantities with physical stock and maintain authorised adjustment reasons when differences are found.",
    ...
    },
    {
      number: "07",
      stage: "Review",
      title: "Monitor Inventory Operations",
      description:
        "Review current balances, low-stock items, receipts, issues, transfers, adjustments, and location-wise movement.",
  ...
  const roleViews: RoleViewItem[] = [
    {
      ...
      description:
        "Complete authorised visibility across stock locations, purchasing, movements, adjustments, suppliers, and reports.",
      permissions: [
        "Manage all inventory records",
    ...
    },
    {
      ...
      description:
        "Manage permitted receipts, issues, transfers, physical verification, and stock-location information.",
      permissions: [
        "Receive authorised stock",
        "Issue permitted items",
    ...
    },
    {
      ...
      description:
        "Access authorised purchase requirements, supplier information, order status, and pending receipt information.",
      permissions: [
    ...
    },
    {
      ...
      description:
        "Request permitted items and review inventory activity connected with their department, project, or location.",
      permissions: [
  ...
  const advantages: AdvantageItem[] = [
    {
      title: "Connected Stock Records",
      description:
        "Keep items, suppliers, purchase requirements, receipts, issues, transfers, adjustments, and locations connected.",
    ...
    },
    {
      ...
      description:
        "Review permitted inventory balances and movement across warehouses, branches, stores, projects, or operating sites.",
    ...
    },
    {
      ...
      description:
        "Maintain clearer records of what was received, issued, transferred, adjusted, reserved, damaged, or still pending.",
      icon: <Boxes className="h-5 w-5" />,
      style: "border-emerald-200 bg-emerald-50 text-emerald-700",
    },
    {
      ...
      description:
        "Limit item creation, purchasing, receipts, issues, adjustments, and reporting according to user responsibility.",
      icon: <LockKeyhole className="h-5 w-5" />,
      style: "border-cyan-200 bg-cyan-50 text-cyan-700",
    },
    {
      title: "Searchable Movement History",
      description:
        "Locate items, SKUs, suppliers, receipts, issues, transfers, and adjustments without searching separate registers.",
    ...
    },
    {
      ...
      description:
        "Use connected records to understand stock balance, movement, shortages, purchasing activity, and location status.",
      icon: <BarChart3 className="h-5 w-5" />,
      style: "border-amber-200 bg-amber-50 text-amber-700",
    },
  ];
    ...
    <div className="overflow-hidden bg-white text-slate-900">
        ...
        <div className="mx-auto grid w-full max-w-[1440px] grid-cols-1 items-center gap-12 px-4 py-14 sm:px-6 sm:py-20 lg:grid-cols-[1.06fr_0.94fr] lg:gap-20 lg:px-10 lg:py-24 xl:px-16">
          ...
          <div className="mx-auto max-w-3xl text-center lg:mx-0 lg:text-left">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-slate-600 sm:text-lg lg:mx-0">
              Manage item masters, SKUs, units, receipts, issues,
              transfers, purchase requirements, suppliers,
              adjustments, warehouses, and reporting through one
              connected cloud-based inventory platform.
            </p>
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <p className="mt-1 text-sm font-bold text-slate-800">
                        Industrial Paint – Blue
                      </p>

                      <p className="mt-1 text-[10px] font-semibold text-slate-500">
                        SKU: PNT-BLU-20L · Unit: Bucket
                      </p>
                    </div>
                ...
                <div className="mt-4 flex items-center gap-3 rounded-2xl border border-emerald-100 bg-emerald-50 p-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 truncate text-[10px] text-slate-500">
                      Item and warehouse balances were updated
                    </p>
                  </div>
            ...
            <div className="absolute -bottom-5 -left-3 hidden items-center gap-3 rounded-2xl border border-slate-200 bg-white px-4 py-3 shadow-xl sm:flex">
              ...
              <div>
                ...
                <p className="mt-0.5 text-[9px] text-slate-500">
                  Procurement can review the requirement
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto w-full max-w-[1440px] px-4 py-16 sm:px-6 sm:py-20 lg:px-10 lg:py-24 xl:px-16">
          <div className="mx-auto max-w-3xl text-center">
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-rose-600">
              Inventory Workflow Challenges
            </span>

            <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-slate-950 sm:text-4xl">
              Replace Disconnected Stock Registers With Connected Records
            </h2>

            <p className="mt-5 text-base leading-8 text-slate-600">
              Inventory operations become difficult to control when
              items, quantities, purchasing, receipts, issues,
              transfers, and locations remain separated across
      ...
      >
        ...
        <div className="mx-auto w-full max-w-[1440px] px-4 py-16 sm:px-6 sm:py-20 lg:px-10 lg:py-24 xl:px-16">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-slate-950 sm:text-4xl">
              Manage Every Operational Layer of Stock Movement
            </h2>

            <p className="mt-5 text-base leading-8 text-slate-600">
              Connect item masters, warehouses, suppliers, purchase
              requirements, receipts, issues, transfers, adjustments,
              and reporting through one structured inventory system.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[0.72fr_1.28fr] lg:items-start lg:gap-20">
            <div className="lg:sticky lg:top-28">
              <span className="text-xs font-bold uppercase tracking-[0.18em] text-violet-600">
                Connected Inventory Lifecycle
              </span>

              <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-slate-950 sm:text-4xl">
                From Item Creation to Stock Verification
              </h2>

              <p className="mt-5 text-base leading-8 text-slate-600">
                Every inventory stage should preserve the information
                created before it. This creates one continuous stock
                record instead of separate item, purchasing, receipt,
                issue, transfer, and audit registers.
              </p>
              ...
              >
                Discuss Your Inventory Workflow
      ...
      <section className="relative isolate overflow-hidden bg-slate-50">
        ...
        <div className="mx-auto w-full max-w-[1440px] px-4 py-16 sm:px-6 sm:py-20 lg:px-10 lg:py-24 xl:px-16">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-slate-950 sm:text-4xl">
              Give Every Inventory Role the Right Operational View
            </h2>

            <p className="mt-5 text-base leading-8 text-slate-600">
              Owners, warehouse teams, procurement users, department
              staff, and project teams require different inventory
      ...
      <section className="border-y border-slate-200 bg-white">
        <div className="mx-auto grid w-full max-w-[1440px] grid-cols-1 gap-12 px-4 py-16 sm:px-6 sm:py-20 lg:grid-cols-[0.8fr_1.2fr] lg:items-center lg:gap-20 lg:px-10 xl:px-16">
          <div>
            <span className="text-xs font-bold uppercase tracking-[0.18em] text-blue-600">
              Inventory Platform Advantages
            </span>

            <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-slate-950 sm:text-4xl">
              One Operational Record for Every Stock Movement
            </h2>

            <p className="mt-5 text-base leading-8 text-slate-600">
              Replace separate item lists, purchase sheets, receipt
              books, issue registers, transfer files, and stock-count
              records with one connected cloud-based inventory
              platform.
            </p>
        ...
        <div className="mx-auto grid w-full max-w-[1440px] grid-cols-1 gap-12 px-4 py-16 sm:px-6 sm:py-20 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-20 lg:px-10 lg:py-24 xl:px-16">
          <div>
            ...
            <h2 className="mt-6 text-3xl font-extrabold tracking-tight sm:text-4xl">
              Keep Warehouses, Procurement, Projects and Management Connected
            </h2>

            <p className="mt-5 text-base leading-8 text-slate-300">
              Authorised users can access permitted item, stock,
              receipt, issue, transfer, purchasing, adjustment, and
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            {[
              {
                title: "Responsive Stock Access",
                description:
                  "Access permitted item, receipt, issue, transfer, request, and stock records through phone, tablet, laptop, or desktop.",
                icon: <MonitorSmartphone className="h-6 w-6" />,
              },
              {
                title: "Secure Role Controls",
                description:
                  "Protect purchasing, stock, adjustment, supplier, project, and management information through role-based permissions.",
                icon: <ShieldCheck className="h-6 w-6" />,
              },
              {
                title: "Centralised Documentation",
                description:
                  "Keep item details, quantities, suppliers, receipts, issues, transfers, adjustments, and notes within structured records.",
                icon: <FileCheck2 className="h-6 w-6" />,
              },
              {
                title: "Expandable Inventory Modules",
                description:
                  "Barcode or QR scanning, POS linkage, purchase approvals, batch tracking, or specialised reports can be developed when required.",
        ...
        <div className="mx-auto w-full max-w-[1440px] px-4 py-16 sm:px-6 sm:py-20 lg:px-10 lg:py-24 xl:px-16">
          <div className="relative isolate overflow-hidden rounded-[28px] bg-gradient-to-r from-blue-700 via-blue-600 to-teal-600 px-6 py-12 text-center shadow-[0_30px_80px_rgba(37,99,235,0.25)] sm:px-10 sm:py-16">
            ...
            <h2 className="mx-auto mt-6 max-w-4xl text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
              Build Inventory Software Around How Your Stock Actually Moves
            </h2>

            <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-blue-50">
              Tell us how items are created, how stock is purchased,
              how goods are received, how materials are issued, how
              transfers are handled, and where quantity mismatches
            ...
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              ...
              >
                Request Inventory Consultation
